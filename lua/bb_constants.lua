...
local CONSTANTS = {
    ...
    COVER_TACTICS_LOS_GRACE = 2,
    COVER_TACTICS_TARGET_MEMORY = 6,
    COVER_TACTICS_PEEK_DURATION = 2,
    COVER_TACTICS_PEEK_RETRY_DELAY = 0.5,
    COVER_TACTICS_MAX_PEEK_ATTEMPTS = 2,
    COVER_TACTICS_REPOSITION_COOLDOWN = 6,
