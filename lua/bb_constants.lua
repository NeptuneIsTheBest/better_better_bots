...
local CONSTANTS = {
    ...
    PROACTIVE_DEFAULT_ENGAGE_RANGE = 1000,
    PROACTIVE_RESUME_RANGE_MUL = 1.2,
    PROACTIVE_OBSTRUCTION_DELAY = 1,
    PROACTIVE_DESTINATION_TOLERANCE = 100,
    PROACTIVE_REPATH_DISTANCE = 1000,
    PROACTIVE_REPATH_INTERVAL = 2,
    PROACTIVE_TARGET_LOCK = 2,
    PROACTIVE_RETRY_COOLDOWN = 5,
    PROACTIVE_NAV_CACHE_TTL = 1,
    PROACTIVE_NAV_PROJECTION_MAX_DISTANCE = 250,
