...
local CONSTANTS = {
    ...
    PROACTIVE_RECALL_ARRIVAL_DISTANCE = 800,
    PROACTIVE_RECALL_UNENGAGED_DURATION = 2,
    ...
    COOP_NEARLY_VISIBLE_FACTOR = 0.85,
    COOP_RECENT_VISIBLE_FACTOR = 0.65,
    COOP_RELOADING_FACTOR = 0.6,
    COOP_STATUS_CACHE_TTL = 0.1,
    COOP_SCORE_CACHE_TTL = 0.1,
    ASSIGNMENT_UPDATE_INTERVAL = 0.2,
