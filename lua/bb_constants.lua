...
local CONSTANTS = {
    ...
    COOP_TARGET_OBSERVATION_TTL = 0.6,
    COOP_BOT_OBSERVATION_TTL = 0.6,
    DOZER_FOCUS_REFRESH = 1,
    COOP_REFRESH_INTERVAL = 0.1,
    ASSIGNMENT_UPDATE_INTERVAL = 0.3,
    ASSIGNED_TARGET_MUL = 1.35,
    UNASSIGNED_TARGET_MUL = 1.05,
    OTHER_ASSIGNMENT_MUL = 0.75,
    ASSIGNMENT_DUMMY_SCORE = 4,
    ASSIGNMENT_BLOCKED_FACTOR = 0.65,
