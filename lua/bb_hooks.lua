...
if RequiredScript == "lib/units/player_team/logics/teamailogicidle" then
    ...
    function TeamAILogicIdle._get_priority_attention(data, attention_objects, reaction_func)
        return CombatBehavior.get_priority_attention(data, attention_objects, reaction_func)
    end
...
if RequiredScript == "lib/units/player_team/logics/teamailogicassault" then
    ...
    TeamAILogicAssault._get_priority_attention = CombatBehavior.get_priority_attention
